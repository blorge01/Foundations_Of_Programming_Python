...
while (True):
    ...
    # Step 5 - Remove a new item from the list/Table
        ...
        if taskDelete.lower() == strN1.lower(): # Limitation note: the string must be an exact match
            lstTable.remove(dicRow)
        # elif taskDelete == dicRow.values():   # Code doesn't work, cannot delete rows read from file
        #    lstTable.remove(dicRow)            # These two rows are an enhancement opportunity
